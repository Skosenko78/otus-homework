...
В процессе выполнения лабораторной работы были получены навыки общения с утилитами для работы с файловой системой Linux. Были добавлены диски в стенд, собран RAID массив 10, проведено удаление и замена дисков в этом массиве. Созданы и смонтированы файловые системы на RAID массиве. 